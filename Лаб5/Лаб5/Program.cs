...
namespace Лабораторная5
{
    ...
    {   
        ...
        static void Main()
        {
            /* 1 
            string str1 = "Строка1";
            string str2 = new string('t', 4);      
            char[] charray ={'l','a','b','a'};
            ...
            string str5 = "Вот такая \"Строка\" и  \", которая выводится\"", str6 ="";
            int k = 0;
            ...
            /* 3
            string a = "Я иду, Я устала, Зачем так сложно, Вот пример split";
            functional(a);*/

            /* 4 
            TestStringBuilder();
            StringBuilder a = new StringBuilder("Вот так работает метод ");
            StringBuilder b = new StringBuilder("присоеденила строку в начало");
            a.Append("Append");
            b.Insert(0, "Insert ");
            Console.WriteLine(a);
            Console.WriteLine(b);
            ...
            int num = 1;
            string[] sub =
                { "Я не могу придумывать предложения",  "Я не могу придумывать предложения.",  "Я не могу придумывать предложения." };
            foreach(string substr in sub)
                c.AppendFormat(" {0}: {1} ", num++, substr);
            Console.WriteLine(c); */

            /* 5
            StringBuilder a = new StringBuilder("Ради того чтобы что");
            StringBuilder b = new StringBuilder("А что у нас тут");
